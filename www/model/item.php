...
// 8件ずつ商品を表示する
function get_8_items($db, $is_open = false, $start=0){
  $sql = '
    SELECT
      item_id, 
      name,
...
// 登録が新しい順
function get_new_items($db, $is_open = false, $start=0){
  $sql = '
    SELECT
      item_id, 
      name,
...
// 価格の安い順
function get_price_low_items($db, $is_open = false, $start=0){
  $sql = '
    SELECT
      item_id, 
      name,
...
// 価格の高い順
function get_price_high_items($db, $is_open = false, $start=0){
  $sql = '
    SELECT
      item_id, 
      name,
